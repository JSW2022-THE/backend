...
module.exports = {
    ...
    resume: async function (req, res) {
        ...
        if (!req.isAuth) { // 로그인 필수
            ...
            if (req.body.name == "" || req.body.date_or_birth == "" || req.body.address == "" || req.body.etc == "" ||
                req.body.name == undefined || req.body.date_or_birth == undefined || req.body.address == undefined || req.body.etc == undefined) {
                res.status(400);
            ...
            if (flag) {
                ...
                if (dbReqRes == undefined) { // 처음 이력서 작성시
                    await Resume.create({
                        name: req.body.name,
    ...
    getResume: function (req, res) {
        ...
        if (req.query.target_user_uuid != "" || req.query.target_user_uuid != undefined) {
            Resume.findOne({
                where: {
